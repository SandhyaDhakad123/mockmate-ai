    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-white dark:bg-[#050509] transition-colors duration-300">
      ...
      >
        <div className="text-center mb-10">
          <h1 className="text-5xl font-bold dark:text-white text-slate-900 tracking-tight">Sign In</h1>
          <p className="mt-2 text-slate-500 dark:text-slate-400 text-base">Continue your interview prep journey</p>
        </div>
